            ...
            <div class="col-md-6 col-lg-4">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div className="row">
                            <p class="card-text text-left col"><small style={{ "background-color": "rgba(0, 123, 255, 0.1)", "border-radius": "6px" }}>&nbsp;{this.props.deal.category}&nbsp;</small></p>
                            <p class="card-text text-right col"><small style={{ "background-color": "rgba(0, 123, 255, 0.1)", "border-radius": "6px" }}>&nbsp;{this.props.deal.city}&nbsp;</small></p>
                        </div>
