                ...
                <div className="container">
                    <div className="row justify-content-center top-footer">
                        ...
                        <div className="col-12 col-md-7 mt-3">
                            ...
                            <p>
                                If you have questions or would like us to post on our website please contact us!
                        </p>
                        </div>
                        ...
                        <div className="col-auto align-self-center">
                            ...
                            <a className="btn btn-social-icon btn-linkedin" href="https://www.linkedin.com/company/deal-alchemist/"><i className="fa fa-linkedin"></i></a>
